...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React45.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React45.useRef(false);
  const handleEntering = React45.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React45.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React45.useCallback(() => {
    dispatch("exiting");
  }, []);
...
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React72.useState(!requestedEnter);
  React72.useEffect(() => {
    if (requestedEnter) {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React73.useRef(false);
  const firstFocus = React73.useRef(true);
  const inputRef = React73.useRef(null);
  const listboxRef = React73.useRef(null);
  const [anchorEl, setAnchorEl] = React73.useState(null);
  const [focusedTag, setFocusedTag] = React73.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React73.useRef(defaultHighlighted);
  ...
  const resetInputValue = React73.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React73.useState(true);
  ...
  const syncHighlightedIndex = React73.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React73.useRef(false);
...
var Input3 = React75.forwardRef(function Input4(inProps, ref) {
...
var FilledInput = React76.forwardRef(function FilledInput2(inProps, ref) {
  var _ref, _slots$root, _ref2, _slots$input;
  const props = useThemeProps({
    props: inProps,
    name: "MuiFilledInput"
...
var OutlinedInput = React78.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime55.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime55.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime54.jsxs)(React78.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var FormLabel = React79.forwardRef(function FormLabel2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFormLabel"
  });
...
var InputLabel = React80.forwardRef(function InputLabel2(inProps, ref) {
  const props = useThemeProps({
    name: "MuiInputLabel",
    props: inProps
  });
...
var Select3 = React94.forwardRef(function Select4(inProps, ref) {
  ...
  return (0, import_jsx_runtime74.jsx)(React94.Fragment, {
...
var TextField = React95.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RU7TYGG6.js.map
